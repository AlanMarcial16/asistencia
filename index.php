...
<div class="container">
    ...
    <div class="form-container">
        ...
        <div class="button-container">
            <button class="button primary" onclick="location.href='form.php';">Registro de Entrada</button>
            <button class="button secondary" onclick="location.href='form2.php';">Registro de Salida</button>
        </div>
    </div>
</div>
