...
<div class="container">
    ...
    <div class="form-container">
        ...
        ?>
            ...
            <!-- Agregar un contenedor para mostrar el código QR -->
...
document.getElementById('nombre').addEventListener('change', function() {
    ...
    var nombreEmpleado = this.options[this.selectedIndex].text;
    
    // Construir la ruta del archivo del código QR
    var rutaQR = 'qr_codes/qr_' + nombreEmpleado + '.png';
    
    // Mostrar el contenedor del código QR y establecer la imagen
    document.getElementById('qr-container').style.display = 'block';
    document.getElementById('qr-image').src = rutaQR;
